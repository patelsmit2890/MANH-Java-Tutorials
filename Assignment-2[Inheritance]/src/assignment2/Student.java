...
public class Student {
	...
	String courseName;	 
	String firstSubject;
	double scoreFirstSubject;
	String secondSubject;
	double scoreSecondSubject;
	/**
	...
	public void display(String rollNumber){
		if(verifyRollNum(rollNumber)){
			if(this.scoreFirstSubject>this.scoreSecondSubject){
				...
				System.out.println("First Subject Marks: "+scoreFirstSubject);
				System.out.println("Second Subject Marks: "+scoreSecondSubject);
			}else{
